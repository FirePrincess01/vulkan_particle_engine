//
// @file:   advanced_descriptor_sets.h
// @author: FirePrincess
// @date:   2023-01-03
// @brief:  Description of uniform buffers
//
...
inline void AdvancedDescriptorSets::createDescriptorSets(RenderEngineInterface& engine, 
        vk::DescriptorPool const & descriptorPool, vk::DescriptorSetLayout const & descriptorSetLayout, 
        std::vector<vk::UniqueBuffer> const& uniformBuffers, size_t const UniformBufferObjectSize,
		std::vector<vk::UniqueBuffer> const& storageBuffers, size_t const StorageBufferObjectSize) 
{
...
inline std::vector<vk::DescriptorSet> const & AdvancedDescriptorSets::getDescriptorSets()
{
    return descriptorSets;
}

inline void AdvancedDescriptorSets::clear() 
{
